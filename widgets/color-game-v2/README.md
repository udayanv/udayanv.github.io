...
- `designDoc-v2.md` — active product and architecture plan
- `codexInstructions.md` — historical implementation brief tied to the active plan
- `ArchivedDocs/` — superseded reference material; do not treat it as current guidance
